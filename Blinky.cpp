...
Blinky::Blinky(int arr[14][17],int a,int b):Enemy(arr,"chase") {
	position_x=a;
	position_y=b;
	enemyNumber=0;
}
void Blinky::setEnemyPosition(int a,int b){
	position_x=a;
	position_y=b;
}
void Blinky::getEnemyPosition(int& a,int& b){
	a=position_x;
	b=position_y;
}
void Blinky::setTargetPostion(int a,int b){
	pacX=a;
	pacY=b;
}
void Blinky::BFS(){

...
Clyde::Clyde(int arr[14][17],int a,int b):Enemy(arr,"chase") {
	position_x=a;
	position_y=b;
	enemyNumber=3;
}
void Clyde::setEnemyPosition(int a,int b){
	position_x=a;
	position_y=b;
}
void Clyde::getEnemyPosition(int& a,int& b){
	a=position_x;
	b=position_y;
}
void Clyde::setTargetPostion(int a,int b){
	pacX=a;
	pacY=b;
}
void Clyde::BFS(){
